 ...
 * Layout: 
 * - Mobile: Vertical Stack (Hero -> Info -> Gallery -> 360 -> RSVP) *Order Updated*
          ...
          <div className="w-full md:max-w-3xl lg:max-w-7xl mx-auto bg-zinc-900 lg:border lg:border-neutral-800 lg:shadow-[0_0_60px_rgba(185,28,28,0.3)] lg:rounded-3xl overflow-hidden relative flex flex-col lg:flex-row lg:h-[90vh]">
            ...
            <div className="w-full lg:w-[45%] flex flex-col bg-zinc-900 h-auto lg:h-full relative">
                ...
                <div className="h-auto lg:flex-1 lg:overflow-y-auto pb-24 lg:pb-32 no-scrollbar"> 
                    ...
                    {/* MOBILE/TABLET: Gallery & 360 (Swapped Order) */}
            ...
            <div className="fixed lg:absolute bottom-0 w-full bg-black/95 backdrop-blur-lg p-4 flex flex-col gap-3 border-t border-neutral-800 z-50 lg:rounded-br-3xl lg:absolute lg:w-full">
